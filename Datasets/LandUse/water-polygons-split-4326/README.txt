...
coastline water polygons, split into a grid with slight overlap.

Layers contained are:

water_polygons.shp:

  53302 Polygon features
  WGS84 geographic coordinates (EPSG: 4326)
  Extent: (-180.000, -78.739) - (180.000, 90.000)

Date of the data used is 2025-08-07T00:00:00Z
...
This data is Copyright 2025 OpenStreetMap contributors. It is
